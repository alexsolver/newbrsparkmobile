 ...
 * **Composer de formulários** (`openAiCopilotJson` em `formAiCopilot.js`): usa por defeito **gpt-4o** (não este `model` da integração). Para outro modelo só no Composer: env **OPENAI_COPILOT_MODEL** (ex.: `gpt-4.1`, ou `gpt-4o-mini` para forçar barato).
