...
const providers = [
  ...
  { category: 'Climatização', name: 'Refrigeração Total', rating: 4.5, reviews: 98, verified: false, city: 'São Paulo', tags: ['câmara fria','comercial'], keywords: 'câmara fria refrigeração comercial restaurante supermercado', phone: '(11) 98007-0003' },
