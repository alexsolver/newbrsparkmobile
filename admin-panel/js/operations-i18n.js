...
const M = {
  'pt-BR': {
    ...
    ops_card_cancel_confirm: 'Cancelar esta OS? O estado passará a «cancelada».',
    ops_card_cancel_ok: 'OS cancelada com sucesso.',
    ops_card_cancel_err: 'Erro ao cancelar:',
  ...
  'en-US': {
    ...
    ops_card_cancel_confirm: 'Cancel this work order? It will be marked as cancelled.',
    ops_card_cancel_ok: 'Work order cancelled.',
    ops_card_cancel_err: 'Could not cancel:',
