...
const M = {
  'pt-BR': {
    ...
    cmp_type_MOBILE_EULA: 'EULA / Termos do App Mobile',
    cmp_type_LOCATION_NOTICE: 'Aviso de Geolocalização',
    cmp_type_BIOMETRIC_NOTICE: 'Aviso de Biometria',
    cmp_type_WORK_TIME_POLICY: 'Política de Jornada / Ponto',
    cmp_type_AI_USAGE_POLICY: 'Política de Uso de IA',
    cmp_type_DATA_RETENTION_POLICY: 'Política de Retenção de Dados',
    cmp_type_SUBPROCESSORS_LIST: 'Lista de Suboperadores',
    cmp_type_SLA_SUPPORT_POLICY: 'SLA e Suporte',
    cmp_type_BILLING_REFUND_POLICY: 'Billing, Cancelamento e Reembolso',
    cmp_type_PROVIDER_TERMS: 'Termos de Prestador',
    cmp_type_KYC_NOTICE: 'Aviso de Cadastro/KYC',
    cmp_type_ACCEPTABLE_USE_POLICY: 'Política de Uso Aceitável',
    cmp_type_SECURITY_POLICY: 'Política de Segurança',
    cmp_alert_err: 'Erro: {detail}',
    cmp_editor_editing: 'Editando: {title}',
    cmp_help_title: 'Como isto funciona (em 30 segundos)',
    cmp_help_body:
      '<strong>Cada combinação «tipo de documento» + «idioma» é um registo separado.</strong> Ex.: «Termos de uso» em português e «Termos de uso» em inglês são duas versões diferentes. O utilizador vê o texto no idioma da app; se não existir tradução publicada, o sistema pode mostrar outro idioma de recurso.<br><br><strong>Vigente</strong> = versão que o app/site usa hoje para esse tipo e idioma. <strong>Minuta</strong> = texto guardado mas ainda não publicado (revisão jurídica). Use o filtro abaixo para focar num idioma.',
    cmp_filter_locale_lbl: 'Mostrar lista para',
    cmp_filter_all: 'Todos os idiomas (visão geral)',
    cmp_locale_long_ptBR: 'Português — pt-BR',
    cmp_locale_long_enUS: 'English — en-US',
    cmp_locale_long_esES: 'Español — es-ES',
    cmp_locale_long_deDE: 'Deutsch — de-DE',
    cmp_locale_strip_hint: 'Cada cartão = um idioma. Publique uma versão por idioma quando quiser que os utilizadores vejam esse texto.',
    cmp_locale_filter_active_hint:
      'Lista focada em {lang}. Para ver os quatro idiomas em grelha ao mesmo tempo, escolha «Todos os idiomas» no filtro acima.',
    cmp_no_version_locale: 'Sem documento neste idioma.',
    cmp_minuta: 'Minuta',
    cmp_vigente: 'Vigente',
    cmp_publicado: 'Publicado',
    cmp_criado: 'Criado',
    cmp_sem_ativo_tipo: 'Nenhuma versão vigente neste tipo',
    cmp_hist_title: 'Histórico de versões',
    cmp_hist_empty_filtered: 'Sem linhas para este idioma (altere o filtro ou crie uma versão).',
    cmp_hist_col_ver: 'Versão',
    cmp_hist_col_locale: 'Idioma',
    cmp_hist_col_status: 'Estado',
    cmp_hist_col_title: 'Título',
    cmp_hist_col_accepts: 'Aceitações',
    cmp_hist_col_date: 'Data',
    cmp_hist_col_actions: 'Ações',
    cmp_btn_edit_vigente: 'Editar vigente',
    cmp_btn_edit_minuta: 'Editar minuta',
    cmp_btn_pub: 'Publicar',
    cmp_btn_confirm: 'Confirmar?',
    cmp_btn_hist: 'Histórico',
    cmp_btn_new_version: 'Nova versão',
    cmp_btn_new_locale: 'Nova versão neste idioma',
    cmp_accept_count: 'aceitações',
    cmp_editor_sec_doc: 'Documento e idioma',
    cmp_editor_sec_audience: 'Quem vê e onde aparece',
    cmp_editor_sec_legal: 'Revisão jurídica e vigência',
    cmp_editor_sec_content: 'Texto legal (Markdown)',
    cmp_editor_locale_help:
      'Escolha o idioma do <em>texto</em> que está a escrever. Para traduzir, crie outro registo com o mesmo tipo, altere o idioma e use a mesma versão (ex.: 2026.04.1) se quiser alinhar as línguas.',
    cmp_status_DRAFT: 'Rascunho',
    cmp_status_LEGAL_REVIEW: 'Em revisão jurídica',
    cmp_status_APPROVED: 'Aprovado',
    cmp_status_PUBLISHED: 'Publicado',
    cmp_status_ARCHIVED: 'Arquivado',
    cmp_err_required: 'Preencha versão, título e conteúdo antes de guardar.',
    cmp_err_save: 'Erro ao guardar. Tente novamente.',
    cmp_ver_one: '1 versão',
    cmp_ver_n: '{n} versões',
    cmp_pending_one: '1 pendente',
    cmp_pending_n: '{n} pendentes',
    cmp_accept_registered: '{n} aceitações registradas',
    cmp_hist_expired: 'Expirada / arquivo',
    cmp_btn_edit: 'Editar',
    cmp_btn_archive: 'Arquivar',
    cmp_meta_audience: 'Público: {v}',
    cmp_meta_platform: 'Plataforma: {v}',
    cmp_meta_jurisdiction: 'Jurisdição: {v}',
    cmp_meta_basis: 'Base: {v}',
    cmp_require_accept: 'Exige aceite',
    cmp_informativo: 'Informativo',
    cmp_blocking: 'Bloqueante',
    cmp_pub_working: 'A publicar…',
    cmp_save_working: 'A guardar…',
    cmp_archive_vigente: 'Arquivar vigente',
    cmp_archive_minuta: 'Arquivar minuta',
    cmp_confirm_archive: 'Confirmar arquivo',
    cmp_archive_query: 'Arquivar?',
    cmp_lbl_audience: 'Público-alvo',
    cmp_lbl_platform: 'Plataforma',
    cmp_lbl_jurisdiction: 'Jurisdição',
    cmp_lbl_legal_basis: 'Base legal',
    cmp_lbl_review_status: 'Estado jurídico',
    cmp_lbl_effective_from: 'Vigência a partir de',
    cmp_lbl_change_summary: 'Resumo da alteração',
    cmp_ph_change_summary: 'Ex.: novo aviso de GPS em segundo plano e biometria.',
    cmp_tgl_require_title: 'Exige aceite',
    cmp_tgl_require_sub: 'Regista aceite ou consentimento por versão',
    cmp_tgl_block_title: 'Bloqueante',
    cmp_tgl_block_sub: 'O utilizador tem de aceitar para continuar',
    cmp_aud_ALL: 'Todos',
    cmp_aud_PUBLIC: 'Público',
    cmp_aud_TENANT_ADMIN: 'Admin do tenant',
    cmp_aud_TECHNICIAN: 'Técnico / campo',
    cmp_aud_PROVIDER: 'Prestador',
    cmp_aud_EMPLOYEE: 'Empregado',
    cmp_aud_CUSTOMER: 'Cliente final',
    cmp_plat_ALL: 'Todas',
    cmp_plat_WEB: 'Web pública',
    cmp_plat_MOBILE: 'App mobile',
    cmp_plat_ADMIN: 'Painel admin',
    cmp_plat_API: 'API / integrações',
    cmp_jur_GLOBAL: 'Global',
    cmp_jur_BR: 'Brasil',
    cmp_jur_EU: 'União Europeia',
    cmp_jur_ES: 'Espanha',
    cmp_jur_DE: 'Alemanha',
    cmp_jur_US: 'Estados Unidos',
    cmp_jur_AR: 'Argentina',
    cmp_basis_: 'Não definida',
    cmp_basis_LGPD: 'LGPD',
    cmp_basis_GDPR: 'GDPR',
    cmp_basis_CCPA: 'CCPA/CPRA',
    cmp_basis_CONTRACT: 'Execução de contrato',
    cmp_basis_CONSENT: 'Consentimento',
    cmp_basis_LEGITIMATE_INTEREST: 'Interesse legítimo',
    cmp_basis_LEGAL_OBLIGATION: 'Obrigação legal',
    cmp_rev_DRAFT: 'Rascunho',
    cmp_rev_LEGAL_REVIEW: 'Em revisão jurídica',
...
M['en-US'] = {
  ...
  cmp_type_MOBILE_EULA: 'Mobile app EULA / terms',
  cmp_type_LOCATION_NOTICE: 'Location notice',
  cmp_type_BIOMETRIC_NOTICE: 'Biometric notice',
  cmp_type_WORK_TIME_POLICY: 'Work time / time tracking policy',
  cmp_type_AI_USAGE_POLICY: 'AI usage policy',
  cmp_type_DATA_RETENTION_POLICY: 'Data retention policy',
  cmp_type_SUBPROCESSORS_LIST: 'Subprocessors list',
  cmp_type_SLA_SUPPORT_POLICY: 'SLA and support',
  cmp_type_BILLING_REFUND_POLICY: 'Billing, cancellation and refund',
  cmp_type_PROVIDER_TERMS: 'Provider terms',
  cmp_type_KYC_NOTICE: 'Onboarding/KYC notice',
  cmp_type_ACCEPTABLE_USE_POLICY: 'Acceptable use policy',
  cmp_type_SECURITY_POLICY: 'Security policy',
  cmp_alert_err: 'Error: {detail}',
  cmp_editor_editing: 'Editing: {title}',
  cmp_help_title: 'How it works (30 seconds)',
  cmp_help_body:
    '<strong>Each «document type» + «language» pair is a separate record.</strong> Example: «Terms of use» in Portuguese and «Terms of use» in English are two different documents. Users see the text in their app language; if no published translation exists, a fallback language may be shown.<br><br><strong>Active</strong> = version the app/site uses today for that type and language. <strong>Draft</strong> = saved but not yet published (legal review). Use the filter below to focus on one language.',
  cmp_filter_locale_lbl: 'Show list for',
  cmp_filter_all: 'All languages (overview)',
  cmp_locale_long_ptBR: 'Portuguese — pt-BR',
  cmp_locale_long_enUS: 'English — en-US',
  cmp_locale_long_esES: 'Spanish — es-ES',
  cmp_locale_long_deDE: 'German — de-DE',
  cmp_locale_strip_hint: 'Each card is one language. Publish one active version per language when you want users to see that text.',
  cmp_locale_filter_active_hint:
    'The list is focused on {lang}. To see all four languages in the grid, pick «All languages» in the filter above.',
  cmp_no_version_locale: 'No document in this language yet.',
  cmp_minuta: 'Draft',
  cmp_vigente: 'Active',
  cmp_publicado: 'Published',
  cmp_criado: 'Created',
  cmp_sem_ativo_tipo: 'No active version for this document type',
    cmp_hist_title: 'Version history',
    cmp_hist_empty_filtered: 'No rows for this language (change the filter or create a version).',
  cmp_hist_col_ver: 'Version',
  cmp_hist_col_locale: 'Language',
  cmp_hist_col_status: 'Status',
  cmp_hist_col_title: 'Title',
  cmp_hist_col_accepts: 'Acceptances',
  cmp_hist_col_date: 'Date',
  cmp_hist_col_actions: 'Actions',
  cmp_btn_edit_vigente: 'Edit active',
  cmp_btn_edit_minuta: 'Edit draft',
  cmp_btn_pub: 'Publish',
  cmp_btn_confirm: 'Confirm?',
  cmp_btn_hist: 'History',
  cmp_btn_new_version: 'New version',
  cmp_btn_new_locale: 'New version in this language',
  cmp_accept_count: 'acceptances',
  cmp_editor_sec_doc: 'Document and language',
  cmp_editor_sec_audience: 'Who sees it and where',
  cmp_editor_sec_legal: 'Legal review and effective date',
  cmp_editor_sec_content: 'Legal text (Markdown)',
  cmp_editor_locale_help:
    'Pick the language of the <em>text</em> you are writing. To translate, create another record with the same type, change the language, and use the same version number (e.g. 2026.04.1) if you want languages aligned.',
  cmp_status_DRAFT: 'Draft',
  cmp_status_LEGAL_REVIEW: 'Legal review',
  cmp_status_APPROVED: 'Approved',
  cmp_status_PUBLISHED: 'Published',
  cmp_status_ARCHIVED: 'Archived',
    cmp_err_required: 'Fill in version, title and content before saving.',
    cmp_err_save: 'Save failed. Please try again.',
    cmp_ver_one: '1 version',
    cmp_ver_n: '{n} versions',
    cmp_pending_one: '1 pending',
    cmp_pending_n: '{n} pending',
    cmp_accept_registered: '{n} acceptances recorded',
    cmp_hist_expired: 'Superseded / archived',
    cmp_btn_edit: 'Edit',
    cmp_btn_archive: 'Archive',
    cmp_meta_audience: 'Audience: {v}',
    cmp_meta_platform: 'Platform: {v}',
    cmp_meta_jurisdiction: 'Jurisdiction: {v}',
    cmp_meta_basis: 'Basis: {v}',
    cmp_require_accept: 'Requires acceptance',
    cmp_informativo: 'Informational',
    cmp_blocking: 'Blocking',
    cmp_pub_working: 'Publishing…',
    cmp_save_working: 'Saving…',
    cmp_archive_vigente: 'Archive active',
    cmp_archive_minuta: 'Archive draft',
    cmp_confirm_archive: 'Confirm archive',
    cmp_archive_query: 'Archive?',
    cmp_lbl_audience: 'Audience',
    cmp_lbl_platform: 'Platform',
    cmp_lbl_jurisdiction: 'Jurisdiction',
    cmp_lbl_legal_basis: 'Legal basis',
    cmp_lbl_review_status: 'Legal status',
    cmp_lbl_effective_from: 'Effective from',
    cmp_lbl_change_summary: 'Change summary',
    cmp_ph_change_summary: 'e.g. new background GPS and biometric notice.',
    cmp_tgl_require_title: 'Requires acceptance',
    cmp_tgl_require_sub: 'Records versioned acceptance or consent',
    cmp_tgl_block_title: 'Blocking',
    cmp_tgl_block_sub: 'User must accept to continue',
    cmp_aud_ALL: 'All',
    cmp_aud_PUBLIC: 'Public',
    cmp_aud_TENANT_ADMIN: 'Tenant admin',
    cmp_aud_TECHNICIAN: 'Technician / field',
    cmp_aud_PROVIDER: 'Provider',
    cmp_aud_EMPLOYEE: 'Employee',
    cmp_aud_CUSTOMER: 'End customer',
    cmp_plat_ALL: 'All',
    cmp_plat_WEB: 'Public web',
    cmp_plat_MOBILE: 'Mobile app',
    cmp_plat_ADMIN: 'Admin panel',
    cmp_plat_API: 'API / integrations',
    cmp_jur_GLOBAL: 'Global',
    cmp_jur_BR: 'Brazil',
    cmp_jur_EU: 'European Union',
    cmp_jur_ES: 'Spain',
    cmp_jur_DE: 'Germany',
    cmp_jur_US: 'United States',
    cmp_jur_AR: 'Argentina',
    cmp_basis_: 'Not set',
    cmp_basis_LGPD: 'LGPD',
    cmp_basis_GDPR: 'GDPR',
    cmp_basis_CCPA: 'CCPA/CPRA',
    cmp_basis_CONTRACT: 'Contract performance',
    cmp_basis_CONSENT: 'Consent',
    cmp_basis_LEGITIMATE_INTEREST: 'Legitimate interest',
    cmp_basis_LEGAL_OBLIGATION: 'Legal obligation',
    cmp_rev_DRAFT: 'Draft',
...
M['es-ES'] = {
  ...
  cmp_hero_sub:
    'Versiones de términos, políticas y DPA; historial por tipo y aceptaciones registradas. Publicar solo tras revisión jurídica.',
  cmp_btn_new: 'Nueva versión',
  cmp_stat_versions: 'Versiones totales',
  cmp_stat_active: 'Documentos activos',
  cmp_stat_accept: 'Aceptaciones registradas',
  cmp_stat_last: 'Última publicación',
  cmp_table_title: 'Documentos legales',
  cmp_editor_back: '← Volver',
  cmp_editor_new_title: 'Nueva versión',
  cmp_btn_draft: 'Guardar borrador',
  cmp_btn_publish: 'Publicar',
  cmp_lbl_type: 'Tipo',
  cmp_lbl_version: 'Versión',
  cmp_lbl_locale: 'Idioma (locale)',
  cmp_ph_version: 'p. ej. 2.0',
  cmp_lbl_doc_title: 'Título',
  cmp_ph_doc_title: 'Título completo del documento',
  cmp_lbl_content: 'Contenido (Markdown)',
  cmp_ph_content: '# Título\n\nEscriba el contenido en Markdown…',
  cmp_type_TERMS: 'Términos de uso',
  cmp_type_PRIVACY: 'Política de privacidad',
  cmp_type_DPA: 'DPA / tratamiento de datos (LGPD)',
  cmp_type_COOKIE: 'Política de cookies',
  cmp_type_MOBILE_EULA: 'EULA / términos de la app móvil',
  cmp_type_LOCATION_NOTICE: 'Aviso de geolocalización',
  cmp_type_BIOMETRIC_NOTICE: 'Aviso de biometría',
  cmp_type_WORK_TIME_POLICY: 'Política de jornada / fichaje',
  cmp_type_AI_USAGE_POLICY: 'Política de uso de IA',
  cmp_type_DATA_RETENTION_POLICY: 'Política de retención de datos',
  cmp_type_SUBPROCESSORS_LIST: 'Lista de suboperadores',
  cmp_type_SLA_SUPPORT_POLICY: 'SLA y soporte',
  cmp_type_BILLING_REFUND_POLICY: 'Facturación, cancelación y reembolso',
  cmp_type_PROVIDER_TERMS: 'Términos del prestador',
  cmp_type_KYC_NOTICE: 'Aviso de registro / KYC',
  cmp_type_ACCEPTABLE_USE_POLICY: 'Política de uso aceptable',
  cmp_type_SECURITY_POLICY: 'Política de seguridad',
  cmp_alert_err: 'Error: {detail}',
  cmp_editor_editing: 'Editando: {title}',
  cmp_help_title: 'Cómo funciona (30 segundos)',
  cmp_help_body:
    '<strong>Cada combinación «tipo de documento» + «idioma» es un registro distinto.</strong> Ej.: «Términos de uso» en portugués y en inglés son dos documentos. El usuario ve el texto en el idioma de la app; si no hay traducción publicada, puede mostrarse un idioma alternativo.<br><br><strong>Vigente</strong> = versión que la app/web usa hoy para ese tipo e idioma. <strong>Borrador</strong> = texto guardado pero no publicado (revisión jurídica). Use el filtro para centrarse en un idioma.',
  cmp_filter_locale_lbl: 'Mostrar lista para',
  cmp_filter_all: 'Todos los idiomas (visión general)',
  cmp_locale_long_ptBR: 'Portugués — pt-BR',
  cmp_locale_long_enUS: 'Inglés — en-US',
  cmp_locale_long_esES: 'Español — es-ES',
  cmp_locale_long_deDE: 'Alemán — de-DE',
  cmp_locale_strip_hint: 'Cada tarjeta es un idioma. Publique una versión activa por idioma cuando quiera que los usuarios vean ese texto.',
  cmp_locale_filter_active_hint:
    'Lista centrada en {lang}. Para ver los cuatro idiomas en cuadrícula, elija «Todos los idiomas» en el filtro.',
  cmp_no_version_locale: 'Aún no hay documento en este idioma.',
  cmp_minuta: 'Borrador',
  cmp_vigente: 'Vigente',
  cmp_publicado: 'Publicado',
  cmp_criado: 'Creado',
  cmp_sem_ativo_tipo: 'Ninguna versión vigente para este tipo',
    cmp_hist_title: 'Historial de versiones',
    cmp_hist_empty_filtered: 'Sin entradas para este idioma (cambie el filtro o cree una versión).',
  cmp_hist_col_ver: 'Versión',
  cmp_hist_col_locale: 'Idioma',
  cmp_hist_col_status: 'Estado',
  cmp_hist_col_title: 'Título',
  cmp_hist_col_accepts: 'Aceptaciones',
  cmp_hist_col_date: 'Fecha',
  cmp_hist_col_actions: 'Acciones',
  cmp_btn_edit_vigente: 'Editar vigente',
  cmp_btn_edit_minuta: 'Editar borrador',
  cmp_btn_pub: 'Publicar',
  cmp_btn_confirm: '¿Confirmar?',
  cmp_btn_hist: 'Historial',
  cmp_btn_new_version: 'Nueva versión',
  cmp_btn_new_locale: 'Nueva versión en este idioma',
  cmp_accept_count: 'aceptaciones',
  cmp_editor_sec_doc: 'Documento e idioma',
  cmp_editor_sec_audience: 'Quién lo ve y dónde',
  cmp_editor_sec_legal: 'Revisión jurídica y vigencia',
  cmp_editor_sec_content: 'Texto legal (Markdown)',
  cmp_editor_locale_help:
    'Elija el idioma del <em>texto</em> que está escribiendo. Para traducir, cree otro registro con el mismo tipo, cambie el idioma y use el mismo número de versión (p. ej. 2026.04.1) si desea alinear idiomas.',
  cmp_status_DRAFT: 'Borrador',
  cmp_status_LEGAL_REVIEW: 'En revisión jurídica',
  cmp_status_APPROVED: 'Aprobado',
  cmp_status_PUBLISHED: 'Publicado',
  cmp_status_ARCHIVED: 'Archivado',
    cmp_err_required: 'Complete versión, título y contenido antes de guardar.',
    cmp_err_save: 'Error al guardar. Inténtelo de nuevo.',
    cmp_ver_one: '1 versión',
    cmp_ver_n: '{n} versiones',
    cmp_pending_one: '1 pendiente',
    cmp_pending_n: '{n} pendientes',
    cmp_accept_registered: '{n} aceptaciones registradas',
    cmp_hist_expired: 'Reemplazada / archivada',
    cmp_btn_edit: 'Editar',
    cmp_btn_archive: 'Archivar',
    cmp_meta_audience: 'Público: {v}',
    cmp_meta_platform: 'Plataforma: {v}',
    cmp_meta_jurisdiction: 'Jurisdicción: {v}',
    cmp_meta_basis: 'Base: {v}',
    cmp_require_accept: 'Requiere aceptación',
    cmp_informativo: 'Informativo',
    cmp_blocking: 'Bloqueante',
    cmp_pub_working: 'Publicando…',
    cmp_save_working: 'Guardando…',
    cmp_archive_vigente: 'Archivar vigente',
    cmp_archive_minuta: 'Archivar borrador',
    cmp_confirm_archive: 'Confirmar archivo',
    cmp_archive_query: '¿Archivar?',
    cmp_lbl_audience: 'Público objetivo',
    cmp_lbl_platform: 'Plataforma',
    cmp_lbl_jurisdiction: 'Jurisdicción',
    cmp_lbl_legal_basis: 'Base legal',
    cmp_lbl_review_status: 'Estado jurídico',
    cmp_lbl_effective_from: 'Vigencia desde',
    cmp_lbl_change_summary: 'Resumen del cambio',
    cmp_ph_change_summary: 'p. ej. nuevo aviso de GPS en segundo plano y biometría.',
    cmp_tgl_require_title: 'Requiere aceptación',
    cmp_tgl_require_sub: 'Registra aceptación o consentimiento por versión',
    cmp_tgl_block_title: 'Bloqueante',
    cmp_tgl_block_sub: 'El usuario debe aceptar para continuar',
    cmp_aud_ALL: 'Todos',
    cmp_aud_PUBLIC: 'Público',
    cmp_aud_TENANT_ADMIN: 'Admin del tenant',
    cmp_aud_TECHNICIAN: 'Técnico / campo',
    cmp_aud_PROVIDER: 'Prestador',
    cmp_aud_EMPLOYEE: 'Empleado',
    cmp_aud_CUSTOMER: 'Cliente final',
    cmp_plat_ALL: 'Todas',
    cmp_plat_WEB: 'Web pública',
    cmp_plat_MOBILE: 'App móvil',
    cmp_plat_ADMIN: 'Panel admin',
    cmp_plat_API: 'API / integraciones',
    cmp_jur_GLOBAL: 'Global',
    cmp_jur_BR: 'Brasil',
    cmp_jur_EU: 'Unión Europea',
    cmp_jur_ES: 'España',
    cmp_jur_DE: 'Alemania',
    cmp_jur_US: 'Estados Unidos',
    cmp_jur_AR: 'Argentina',
    cmp_basis_: 'No definida',
    cmp_basis_LGPD: 'LGPD',
    cmp_basis_GDPR: 'GDPR',
    cmp_basis_CCPA: 'CCPA/CPRA',
    cmp_basis_CONTRACT: 'Ejecución del contrato',
    cmp_basis_CONSENT: 'Consentimiento',
    cmp_basis_LEGITIMATE_INTEREST: 'Interés legítimo',
    cmp_basis_LEGAL_OBLIGATION: 'Obligación legal',
    cmp_rev_DRAFT: 'Borrador',
    cmp_rev_LEGAL_REVIEW: 'En revisión jurídica',
    cmp_rev_APPROVED: 'Aprobado',
...
M['de-DE'] = {
  ...
  cmp_type_MOBILE_EULA: 'Mobile-App-EULA / Bedingungen',
  cmp_type_LOCATION_NOTICE: 'Standorthinweis',
  cmp_type_BIOMETRIC_NOTICE: 'Biometriehinweis',
  cmp_type_WORK_TIME_POLICY: 'Arbeitszeit-/Zeiterfassungspolitik',
  cmp_type_AI_USAGE_POLICY: 'KI-Nutzungsrichtlinie',
  cmp_type_DATA_RETENTION_POLICY: 'Datenaufbewahrungsrichtlinie',
  cmp_type_SUBPROCESSORS_LIST: 'Liste der Unterauftragsverarbeiter',
  cmp_type_SLA_SUPPORT_POLICY: 'SLA und Support',
  cmp_type_BILLING_REFUND_POLICY: 'Abrechnung, Kündigung und Erstattung',
  cmp_type_PROVIDER_TERMS: 'Dienstleisterbedingungen',
  cmp_type_KYC_NOTICE: 'Onboarding-/KYC-Hinweis',
  cmp_type_ACCEPTABLE_USE_POLICY: 'Richtlinie zur akzeptablen Nutzung',
  cmp_type_SECURITY_POLICY: 'Sicherheitsrichtlinie',
  cmp_alert_err: 'Fehler: {detail}',
  cmp_editor_editing: 'Bearbeitung: {title}',
  cmp_help_title: 'So funktioniert’s (30 Sekunden)',
  cmp_help_body:
    '<strong>Jede Kombination «Dokumenttyp» + «Sprache» ist ein eigener Datensatz.</strong> Beispiel: «Nutzungsbedingungen» auf Portugiesisch und auf Englisch sind zwei Dokumente. Nutzer sehen den Text in ihrer App-Sprache; ohne veröffentlichte Übersetzung kann ein Fallback gelten.<br><br><strong>Aktiv</strong> = Version, die die App/die Website heute für diesen Typ und diese Sprache nutzt. <strong>Entwurf</strong> = gespeichert, aber noch nicht veröffentlicht (rechtliche Prüfung). Nutzen Sie den Filter, um eine Sprache zu fokussieren.',
  cmp_filter_locale_lbl: 'Liste anzeigen für',
  cmp_filter_all: 'Alle Sprachen (Überblick)',
  cmp_locale_long_ptBR: 'Portugiesisch — pt-BR',
  cmp_locale_long_enUS: 'Englisch — en-US',
  cmp_locale_long_esES: 'Spanisch — es-ES',
  cmp_locale_long_deDE: 'Deutsch — de-DE',
  cmp_locale_strip_hint: 'Jede Karte ist eine Sprache. Veröffentlichen Sie pro Sprache eine aktive Version, wenn Nutzer diesen Text sehen sollen.',
  cmp_locale_filter_active_hint:
    'Die Liste ist auf {lang} fokussiert. Wählen Sie oben «Alle Sprachen», um alle vier Sprachen in der Kartenansicht zu sehen.',
  cmp_no_version_locale: 'Noch kein Dokument in dieser Sprache.',
  cmp_minuta: 'Entwurf',
  cmp_vigente: 'Aktiv',
  cmp_publicado: 'Veröffentlicht',
  cmp_criado: 'Erstellt',
  cmp_sem_ativo_tipo: 'Keine aktive Version für diesen Dokumenttyp',
  cmp_hist_title: 'Versionsverlauf',
  cmp_hist_empty_filtered: 'Keine Einträge für diese Sprache (Filter ändern oder Version anlegen).',
  cmp_hist_col_ver: 'Version',
  cmp_hist_col_locale: 'Sprache',
  cmp_hist_col_status: 'Status',
  cmp_hist_col_title: 'Titel',
  cmp_hist_col_accepts: 'Zustimmungen',
  cmp_hist_col_date: 'Datum',
  cmp_hist_col_actions: 'Aktionen',
  cmp_btn_edit_vigente: 'Aktive bearbeiten',
  cmp_btn_edit_minuta: 'Entwurf bearbeiten',
  cmp_btn_pub: 'Veröffentlichen',
  cmp_btn_confirm: 'Bestätigen?',
  cmp_btn_hist: 'Verlauf',
  cmp_btn_new_version: 'Neue Version',
  cmp_btn_new_locale: 'Neue Version in dieser Sprache',
  cmp_accept_count: 'Zustimmungen',
  cmp_editor_sec_doc: 'Dokument und Sprache',
  cmp_editor_sec_audience: 'Wer sieht es und wo',
  cmp_editor_sec_legal: 'Rechtsprüfung und Gültigkeit',
  cmp_editor_sec_content: 'Rechtstext (Markdown)',
  cmp_editor_locale_help:
    'Wählen Sie die Sprache des <em>Textes</em>, den Sie schreiben. Für Übersetzungen legen Sie einen weiteren Datensatz mit gleichem Typ an, ändern die Sprache und nutzen ggf. dieselbe Versionsnummer (z. B. 2026.04.1).',
  cmp_status_DRAFT: 'Entwurf',
  cmp_status_LEGAL_REVIEW: 'Rechtliche Prüfung',
  cmp_status_APPROVED: 'Genehmigt',
  cmp_status_PUBLISHED: 'Veröffentlicht',
  cmp_status_ARCHIVED: 'Archiviert',
  cmp_err_required: 'Bitte Version, Titel und Inhalt ausfüllen, bevor Sie speichern.',
  cmp_err_save: 'Speichern fehlgeschlagen. Bitte erneut versuchen.',
  cmp_ver_one: '1 Version',
  cmp_ver_n: '{n} Versionen',
  cmp_pending_one: '1 ausstehend',
  cmp_pending_n: '{n} ausstehend',
  cmp_accept_registered: '{n} erfasste Zustimmungen',
  cmp_hist_expired: 'Ersetzt / archiviert',
  cmp_btn_edit: 'Bearbeiten',
  cmp_btn_archive: 'Archivieren',
  cmp_meta_audience: 'Zielgruppe: {v}',
  cmp_meta_platform: 'Plattform: {v}',
  cmp_meta_jurisdiction: 'Jurisdiktion: {v}',
  cmp_meta_basis: 'Basis: {v}',
  cmp_require_accept: 'Zustimmung erforderlich',
  cmp_informativo: 'Informativ',
  cmp_blocking: 'Blockierend',
  cmp_pub_working: 'Wird veröffentlicht…',
  cmp_save_working: 'Wird gespeichert…',
  cmp_archive_vigente: 'Aktive archivieren',
  cmp_archive_minuta: 'Entwurf archivieren',
  cmp_confirm_archive: 'Archiv bestätigen',
  cmp_archive_query: 'Archivieren?',
  cmp_lbl_audience: 'Zielgruppe',
  cmp_lbl_platform: 'Plattform',
  cmp_lbl_jurisdiction: 'Jurisdiktion',
  cmp_lbl_legal_basis: 'Rechtsgrundlage',
  cmp_lbl_review_status: 'Rechtlicher Status',
  cmp_lbl_effective_from: 'Gültig ab',
  cmp_lbl_change_summary: 'Änderungszusammenfassung',
  cmp_ph_change_summary: 'z. B. neuer Hinweis zu Hintergrund-GPS und Biometrie.',
  cmp_tgl_require_title: 'Zustimmung erforderlich',
  cmp_tgl_require_sub: 'Versionierte Zustimmung oder Einwilligung',
  cmp_tgl_block_title: 'Blockierend',
  cmp_tgl_block_sub: 'Nutzer muss zustimmen, um fortzufahren',
  cmp_aud_ALL: 'Alle',
  cmp_aud_PUBLIC: 'Öffentlich',
  cmp_aud_TENANT_ADMIN: 'Mandanten-Admin',
  cmp_aud_TECHNICIAN: 'Techniker / Außendienst',
  cmp_aud_PROVIDER: 'Dienstleister',
  cmp_aud_EMPLOYEE: 'Mitarbeitende',
  cmp_aud_CUSTOMER: 'Endkundin / Endkunde',
  cmp_plat_ALL: 'Alle',
  cmp_plat_WEB: 'Öffentliches Web',
  cmp_plat_MOBILE: 'Mobile App',
  cmp_plat_ADMIN: 'Admin-Panel',
  cmp_plat_API: 'API / Integrationen',
  cmp_jur_GLOBAL: 'Global',
  cmp_jur_BR: 'Brasilien',
  cmp_jur_EU: 'Europäische Union',
  cmp_jur_ES: 'Spanien',
  cmp_jur_DE: 'Deutschland',
  cmp_jur_US: 'USA',
  cmp_jur_AR: 'Argentinien',
  cmp_basis_: 'Nicht festgelegt',
  cmp_basis_LGPD: 'LGPD',
  cmp_basis_GDPR: 'DSGVO',
  cmp_basis_CCPA: 'CCPA/CPRA',
  cmp_basis_CONTRACT: 'Vertragserfüllung',
  cmp_basis_CONSENT: 'Einwilligung',
  cmp_basis_LEGITIMATE_INTEREST: 'Berechtigtes Interesse',
  cmp_basis_LEGAL_OBLIGATION: 'Rechtliche Verpflichtung',
  cmp_rev_DRAFT: 'Entwurf',
  cmp_rev_LEGAL_REVIEW: 'Rechtliche Prüfung',
  cmp_rev_APPROVED: 'Genehmigt',
...
const COMPLIANCE_STRIP_LOCALE_KEYS = {
  'pt-BR': 'cmp_locale_long_ptBR',
  'en-US': 'cmp_locale_long_enUS',
  'es-ES': 'cmp_locale_long_esES',
  'de-DE': 'cmp_locale_long_deDE',
};

/** Texto de ajuda sob o filtro: visão geral (4 idiomas) vs foco num locale. */
export function updateComplianceLocaleStripHint() {
  const el = document.getElementById('cmp-locale-strip-hint');
  const fl = document.getElementById('cmp-locale-filter');
  if (!el) return;
  const v = fl && fl.value ? fl.value : '';
  if (!v) {
    el.textContent = mpT('cmp_locale_strip_hint');
    return;
  }
  const key = COMPLIANCE_STRIP_LOCALE_KEYS[v] || 'cmp_locale_long_ptBR';
  el.textContent = mpT('cmp_locale_filter_active_hint', { lang: mpT(key) });
}
...
export function applyCompliancePageI18n() {
  ...
  if (b) {
    ...
    b.textContent = '';
    if (ic) b.appendChild(ic);
    b.appendChild(document.createTextNode(mpT('cmp_btn_new_version')));
  }
  ...
  if (ty) {
    const m = {
      ...
      MOBILE_EULA: 'cmp_type_MOBILE_EULA',
      LOCATION_NOTICE: 'cmp_type_LOCATION_NOTICE',
      BIOMETRIC_NOTICE: 'cmp_type_BIOMETRIC_NOTICE',
      WORK_TIME_POLICY: 'cmp_type_WORK_TIME_POLICY',
      AI_USAGE_POLICY: 'cmp_type_AI_USAGE_POLICY',
      DATA_RETENTION_POLICY: 'cmp_type_DATA_RETENTION_POLICY',
      SUBPROCESSORS_LIST: 'cmp_type_SUBPROCESSORS_LIST',
      SLA_SUPPORT_POLICY: 'cmp_type_SLA_SUPPORT_POLICY',
      BILLING_REFUND_POLICY: 'cmp_type_BILLING_REFUND_POLICY',
      PROVIDER_TERMS: 'cmp_type_PROVIDER_TERMS',
      KYC_NOTICE: 'cmp_type_KYC_NOTICE',
      ACCEPTABLE_USE_POLICY: 'cmp_type_ACCEPTABLE_USE_POLICY',
      SECURITY_POLICY: 'cmp_type_SECURITY_POLICY',
    };
  ...
  setText('cmp-help-title-label', 'cmp_help_title');
  setHtml('cmp-help-body', 'cmp_help_body');
  setText('cmp-locale-filter-label', 'cmp_filter_locale_lbl');
  updateComplianceLocaleStripHint();
  const locOpts = [
    ['', 'cmp_filter_all'],
    ['pt-BR', 'cmp_locale_long_ptBR'],
    ['en-US', 'cmp_locale_long_enUS'],
  ...
  const fillLocaleSelect = (sel) => {
    if (!sel) return;
    locOpts.forEach(([val, key], idx) => {
      const o = sel.options[idx];
      if (o && o.value === val) o.textContent = mpT(key);
    });
  };
  fillLocaleSelect(document.getElementById('cmp-locale-filter'));
  const eloc = document.getElementById('editor-locale');
  if (eloc) {
    locOpts.slice(1).forEach(([val, key], idx) => {
      const o = eloc.options[idx];
      if (o && o.value === val) o.textContent = mpT(key);
    });
  }
  setHtml('cmp-editor-locale-hint', 'cmp_editor_locale_help');

  setText('cmp-sec-doc-legend', 'cmp_editor_sec_doc');
  setText('cmp-sec-audience-legend', 'cmp_editor_sec_audience');
  setText('cmp-sec-legal-legend', 'cmp_editor_sec_legal');
  setText('cmp-sec-content-legend', 'cmp_editor_sec_content');
  setText('cmp-lbl-audience', 'cmp_lbl_audience');
  setText('cmp-lbl-platform', 'cmp_lbl_platform');
  setText('cmp-lbl-jurisdiction', 'cmp_lbl_jurisdiction');
  setText('cmp-lbl-legal-basis', 'cmp_lbl_legal_basis');
  setText('cmp-lbl-review-status', 'cmp_lbl_review_status');
  setText('cmp-lbl-effective-from', 'cmp_lbl_effective_from');
  setText('cmp-lbl-change-summary', 'cmp_lbl_change_summary');
  const cs = document.getElementById('editor-change-summary');
  if (cs) cs.placeholder = mpT('cmp_ph_change_summary');
  setText('cmp-tgl-require-title', 'cmp_tgl_require_title');
  setText('cmp-tgl-require-sub', 'cmp_tgl_require_sub');
  setText('cmp-tgl-block-title', 'cmp_tgl_block_title');
  setText('cmp-tgl-block-sub', 'cmp_tgl_block_sub');

  const fillOpts = (selId, pairs) => {
    const sel = document.getElementById(selId);
    if (!sel) return;
    Array.from(sel.options).forEach((o) => {
      const k = pairs[o.value];
      if (k) o.textContent = mpT(k);
    });
  };
  fillOpts('editor-audience', {
    ALL: 'cmp_aud_ALL',
    PUBLIC: 'cmp_aud_PUBLIC',
    TENANT_ADMIN: 'cmp_aud_TENANT_ADMIN',
    TECHNICIAN: 'cmp_aud_TECHNICIAN',
    PROVIDER: 'cmp_aud_PROVIDER',
    EMPLOYEE: 'cmp_aud_EMPLOYEE',
    CUSTOMER: 'cmp_aud_CUSTOMER',
  });
  fillOpts('editor-platform', {
    ALL: 'cmp_plat_ALL',
    WEB: 'cmp_plat_WEB',
    MOBILE: 'cmp_plat_MOBILE',
    ADMIN: 'cmp_plat_ADMIN',
    API: 'cmp_plat_API',
  });
  fillOpts('editor-jurisdiction', {
    GLOBAL: 'cmp_jur_GLOBAL',
    BR: 'cmp_jur_BR',
    EU: 'cmp_jur_EU',
    ES: 'cmp_jur_ES',
    DE: 'cmp_jur_DE',
  ...
  fillOpts('editor-legal-basis', {
    '': 'cmp_basis_',
    LGPD: 'cmp_basis_LGPD',
    GDPR: 'cmp_basis_GDPR',
    CCPA: 'cmp_basis_CCPA',
    CONTRACT: 'cmp_basis_CONTRACT',
    CONSENT: 'cmp_basis_CONSENT',
    LEGITIMATE_INTEREST: 'cmp_basis_LEGITIMATE_INTEREST',
    LEGAL_OBLIGATION: 'cmp_basis_LEGAL_OBLIGATION',
  });
  fillOpts('editor-review-status', {
    DRAFT: 'cmp_rev_DRAFT',
    LEGAL_REVIEW: 'cmp_rev_LEGAL_REVIEW',
    APPROVED: 'cmp_rev_APPROVED',
  });
}
