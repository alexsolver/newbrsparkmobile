...
const S = StyleSheet.create({
  ...
  lockSub: { fontSize: 11, color: colors.slate, textAlign: 'center', lineHeight: 16, marginBottom: 32, fontWeight: '700', textTransform: 'uppercase' },
  ...
  pinKey: { width: 60, height: 60, borderRadius: 30, backgroundColor: colors.background, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: colors.border },
  ...
  emptyText: { color: colors.textSecondary, fontWeight: '800', fontSize: 10, textAlign: 'center', textTransform: 'uppercase' },

  entryCard: { flexDirection: 'row', alignItems: 'flex-start', backgroundColor: '#fff', borderRadius: 16, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: colors.border },
  ...
  entryUser: { fontSize: 8, color: colors.textSecondary, fontWeight: '800', marginBottom: 4, textTransform: 'uppercase' },
  passRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  passText: { flex: 1, fontSize: 11, fontWeight: '900', color: BRAND, letterSpacing: 1.5 },
  eyeBtn: { padding: 4 },
  copyBtn: { padding: 4 },
  entryNote: { fontSize: 7, color: colors.textSecondary, marginTop: 6, fontStyle: 'italic', fontWeight: '800', textTransform: 'uppercase' },
  entryActions: { flexDirection: 'column', gap: 8, marginLeft: 8 },
  actionIcon: { padding: 4 },

  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'flex-end' },
  modalCard: { backgroundColor: colors.background, borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: 24, maxHeight: '88%', paddingBottom: Platform.OS === 'ios' ? 40 : 24 },
  modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 },
  modalTitle: { fontSize: 14, fontWeight: '900', color: BRAND, letterSpacing: -0.3, textTransform: 'uppercase' },
  formLabel: { fontSize: 7, fontWeight: '900', color: colors.textLight, marginBottom: 6, textTransform: 'uppercase', letterSpacing: 1.2 },
  formInput: { backgroundColor: '#fff', borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, fontSize: 12, color: BRAND, fontWeight: '800', borderWidth: 1, borderColor: colors.border, marginBottom: 14 },
  catChip: { flexDirection: 'row', alignItems: 'center', gap: 6, borderWidth: 1.5, borderColor: colors.border, borderRadius: 20, paddingHorizontal: 12, paddingVertical: 8, backgroundColor: '#fff' },
  catChipText: { fontSize: 8, fontWeight: '900', color: colors.textLight, textTransform: 'uppercase' },
